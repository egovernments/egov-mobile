...
public class PinView extends View {
    ...
    private void init()
    {
        ...
        paintLine.setColor(ContextCompat.getColor(context, R.color.dividerColor));
        paintLine.setStyle(Paint.Style.STROKE);
        paintLine.setStrokeWidth(2f);

        paintCircle = new Paint();
        paintCircle.setStyle(Paint.Style.FILL);
        paintCircle.setColor(ContextCompat.getColor(context,R.color.dividerColor));

        paintBox = new Paint(Paint.ANTI_ALIAS_FLAG);
        paintBox.setShadowLayer(5, 0, 0, ContextCompat.getColor(context,R.color.dividerColor));
        ...
        paintDottedLine.setColor(ContextCompat.getColor(context, R.color.dividerColor));
